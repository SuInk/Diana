...
func TestDianaOneBotGroupToolUpdatesReplyPolicyForBotOwner(t *testing.T) {
	...
	if !ok || saved.ChatInLevel != ChatInLevelHigh || saved.ChatInEnabled == nil || !*saved.ChatInEnabled || saved.MinimumReplyMemberLevel != 15 || saved.NaturalInterjectionEnabled == nil || *saved.NaturalInterjectionEnabled {
