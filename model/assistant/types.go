...
type BotConfig struct {
	...
	// LLMIdentityBodyAccountMappingEnabled 让隐私代理连正文里直接写的账号数字一起换成
	// 别名：只换能核实是本群成员的号，其余数字原样保留。隐私代理关掉时它不起作用。
	LLMIdentityBodyAccountMappingEnabled *bool `json:"llm_identity_body_account_mapping_enabled,omitempty"`
...
func DefaultBotConfig() BotConfig {
	...
	return BotConfig{
		...
		LLMIdentityBodyAccountMappingEnabled: boolPointer(true),
...
func (cfg BotConfig) WithDefaults() BotConfig {
	...
	if cfg.LLMIdentityBodyAccountMappingEnabled == nil {
		cfg.LLMIdentityBodyAccountMappingEnabled = boolPointer(true)
	}
...
func PayloadFromConfig(cfg BotConfig) ConfigPayload {
	...
	return ConfigPayload{
		...
		LLMIdentityBodyAccountMappingEnabled: copyBoolPointer(cfg.LLMIdentityBodyAccountMappingEnabled),
...
func ConfigFromPayload(payload ConfigPayload, existing BotConfig) BotConfig {
	cfg := BotConfig{
		...
		LLMIdentityBodyAccountMappingEnabled: copyBoolPointer(payload.LLMIdentityBodyAccountMappingEnabled),
