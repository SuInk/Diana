...
var coreCapabilityDocuments = []capabilityDocument{
	...
	{ID: "core:romance", Title: "人机恋恋爱模式", Content: "主人在控制台开启恋爱模式后，用户本人认真表白时可通过 diana.relationship 的 romance_start 确立恋人关系，好感度和相处时长不够会被温柔婉拒；romance_end 随时可以分手。确立后语气按恋人来、记纪念日，整月和周年当天白天还会主动私聊一句纪念日祝福，但不解锁任何权限。开关默认关闭，关闭时机器人不参与恋爱话题的确立。", Source: "core", Enabled: true},
