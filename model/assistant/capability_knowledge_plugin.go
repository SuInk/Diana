...
var coreCapabilityDocuments = []capabilityDocument{
	...
	{ID: "core:version", Title: "自己的版本与更新状态", Content: "通过 diana.version 报出当前版本号、是正式发布版还是源码构建、这台机器上这个版本什么时候装上的、本次运行了多久、跑在什么系统架构上，以及最新发布版本、有没有新版本可用、这台机器能不能自更新。", Source: "core", Enabled: true},
