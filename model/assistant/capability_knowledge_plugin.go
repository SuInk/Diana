...
var coreCapabilityDocuments = []capabilityDocument{
	...
	{ID: "core:agent-mode", Title: "Agent 标准模式与安全模式", Content: "每台机器人的 Agent 有两种模式，主人在控制台机器人设置里切换。标准模式给全部能力；安全模式对所有人（包括主人）关掉高风险能力：本机命令、编码代理、浏览器脚本，安装 Skill/MCP 和已启用的 MCP 工具，带主人登录态的内置浏览器和浏览器控制扩展，GitHub 写操作、跨会话发消息，写入和整理工作区文件，修改机器人配置、禁言踢人和处理好友加群请求。查资料、记忆、提醒订阅、画图、读工作区文件照常。新建机器人默认安全模式。", Source: "core", Enabled: true},
