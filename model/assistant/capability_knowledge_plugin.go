...
var coreCapabilityDocuments = []capabilityDocument{
	...
	{ID: "core:runtime-model", Title: "自己在用什么模型", Content: "通过 diana.runtime_model 读出本轮实际生效的模型 ID、Provider 名称、接口协议和模型分组（对话/识图等）；同一次对话里换了用途也会跟着变。它只读不改，改配置是 diana.llm_config。", Source: "core", Enabled: true},
