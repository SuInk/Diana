...
const (
	...
	promptToolRelationshipPortrait = "用户明确要求记住自己的长期情况（住在哪、做什么工作、作息、生活习惯、兴趣爱好、家里有谁），或要求改掉、忘掉其中某一栏时，调用 diana.relationship 的 portrait_set / portrait_forget 当场记下来，不要只在嘴上答应。想知道机器人记了自己哪些情况时用 operation=get，结果里的 portrait 就是。画像只对本人和主人可见：别人问某个成员住在哪、做什么工作时，如实说这属于对方的个人情况、不便代答，不要去查也不要转述。"
