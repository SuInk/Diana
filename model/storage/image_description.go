...
func (s *SQLiteStore) GetImageDescription(ctx context.Context, contentSHA256 string) (assistant.ImageDescriptionRecord, bool, error) {
	if s == nil || s.db == nil {
...
`, contentSHA256).Scan(
	...
	if err != nil {
		...
		return assistant.ImageDescriptionRecord{}, false, fmt.Errorf("load image description: %w", err)
	}
	return record, true, nil
}

func (s *SQLiteStore) SaveImageDescription(ctx context.Context, record assistant.ImageDescriptionRecord) error {
	if s == nil || s.db == nil {
		return nil
	}
