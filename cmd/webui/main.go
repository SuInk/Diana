...
func main() {
	...
	botRuntime.SetGroupStyleStore(sqliteStore)
	...
	workspaceHandler := webui.NewAgentWorkspaceHandler(assistant.AgentWorkspaceDir, botRuntime)
	workspaceHandler.SetLogStore(sqliteStore)
