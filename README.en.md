...
| `DIANA_FOLLOW_UP_MAX_CHARS` | follows `DIANA_MAX_REPLY_CHARS` | Length cap for follow-up remarks — the one-liner the bot adds after a plugin posts content; never exceeds `DIANA_MAX_REPLY_CHARS` |
