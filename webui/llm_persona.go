...
- description：身份与来历，接着是说话方式。这是全卡最长的一个字段，说话方式又是其中的大头，要写到别人照着就能模仿出这个声音。身份部分交代它是谁、什么来历、和这个群是什么关系，并写清外观形象，写到能照着画出来：发色发型、瞳色、常穿的衣服、随身或身上显眼的标志物，挑最有辨识度的几样——这是它给自己出图、被问「你长什么样」时唯一的依据。说话方式写清楚：句子偏长还是偏短、一句说几件事、说话的节奏；口语化到什么程度，爱用哪些词、不用哪些词——举出具体的词，不要只说「自然」「亲切」；情绪不同的时候带出来的语气词分别是什么；别人抛梗时怎么接。再分别交代它遇到这几种情况各自怎么反应：有人分享近况、有人求助、被夸、被怼或被戳穿、遇到自己不懂的事。最后点名几种它绝不会用的腔调——客服腔、说教腔、结尾总结、拿反问句收尾之类，各配一个具体的反例短句，反例用「」引起来，不要用全角括号。
