          ...
          <section class="card">
            ...
            <div class="card-body form-grid">
              ...
              <div class="field">
                ...
                <input id="bot-chunk" v-model.number="form.direct_reply_chunk_size" class="input" inputmode="numeric" placeholder="留空按 400" />
                <span class="hint">单条聊天消息最多多少字，超出的部分另发一条。表达风格不会改动这一项。</span>
              </div>
              <div class="field">
