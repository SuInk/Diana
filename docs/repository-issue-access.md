...
但**群里要生效，这个群自己也得被授权聊这个仓库**。按用户的授权只是"这个人可以操作这个仓库"，不是"这个人可以把机器人带进任何一个群往这个仓库写"——后者意味着他能在一个从没被授权聊这个仓库的群里下指令，群里所有人都看得见，上下文也能影响写进去的内容。
...
| --- | --- |
| 私聊 | 生效 |
| 群聊，且该群对这个仓库有任意一条按群授权 | 生效，且不受身份档限制 |
| 群聊，该群对这个仓库没有授权 | 不生效，明确拒绝并说明是群没放开 |

身份档不拦按用户授权的人：按群授权收窄到群主或群管理员，说的是"群里哪些人继承这条群授权"；单独给某个人授权本来就是为了放行不在那一档里的人。
